...
//constants 1
define("PROJECT", "Sqlite Admin");
define("VERSION", "1.9.6");
define("PAGE", '/admin/generator/sqlite');
...
if(!$auth->isAuthorized())
{
	...
	echo "<form action='/admin/generator/sqlite' method='post'>";
	echo $lang['passwd'].": <input type='password' name='password'/><br/>";
	echo "<input type='hidden' name=\"_token\" id=\"_token\" value=\"".csrf_token()."\"/>";
